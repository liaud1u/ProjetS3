...
int main(){
    ...
    life = 10;
    cooldown = 0;
    SDL_Surface *screen,*textePieces;
    Uint8 *keystate;
    SDL_Event event;
    SDL_Rect tilePosition,menuPos,heartPos,zombiePos,elfPos,elfImage,zombieImage,screenPos,statPos,optionsPos,textePos;
    SDL_Surface *dirt,*d_close,*options,*menu,*tree,*ext_d,*ext_g,*hd,*bd,*bg,*heart,*hg,*int_g,*int_d,*hearth,*temp,*heartb,*haut,*crate,*skull,*droite,*gauche,*hole,*ladder,*elf,*zombie,*screenshot,*stat,*piece;
    
    //Initialsiation des variables pour le texte
            ...
            if(wait < 80){
                ...
                for (int z = 0; z<zombieTabS; z++){
                    if(!zombieTab[z].isDead()){
                        ...
                        zombieImage.x = zombieTab[z].getCat() * 32 * 4 + 32 * frame; char pieceCaracter[5] = "";
